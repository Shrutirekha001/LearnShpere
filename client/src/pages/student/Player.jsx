    ...
    <>
      <div className='p-4 sm:p-10 flex flex-col-reverse md:grid md:grid-cols-2 gap-10 md:px-36'>
        ...
        <div className='text-gray-800'>
          <h2 className='text-xl font-semibold bg-gradient-to-r from-blue-600 to-pink-500 text-transparent bg-clip-text'>Course Structure</h2>
                        ...
                        <div className='flex items-center justify-between w-full text-gray-800  md:text-default'>
                          ...
                          <div className='flex gap-2'>
                            {lecture.lectureUrl && <p
                              ...
                              className='text-purple-600 cursor-pointer'>Watch</p>}
          ...
          <div className='flex item-center gap-2 py-3 mt-10'>
           <h1 className='text-xl font-bold bg-gradient-to-r from-blue-600 to-pink-500 text-transparent bg-clip-text'>Rate this Course:</h1>
  ...
  {playerData ? (
    <div>
      ...
      <div className='flex justify-between items-center mt-1'>
        ...
        <button onClick={()=> markLectureAsCompleted(playerData.lectureId)} className='text-purple-600 cursor-pointer'>{progressData && progressData.lectureCompleted.includes(playerData.lectureId) ? 'completed': 'Mark Complete'}</button>
      </div>
    </div>
  )
  :
